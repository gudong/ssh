 ...
 * 
 */
package com.forusoft.framework.dal.dao;
 ...
 *
 */
public interface BaseDao<P extends Po, PK extends java.io.Serializable> extends Dao<P, PK> {
   ...
   * 
   * @param hql
   *            queryString an update/delete query expressed in Hibernate's
   *            query language
   * @param values
   ...
   * @return
   */
  public List<P> query(String hql, int firstResult, int maxResults,
      Object... values);
   ...
   * @return
   */
  public List query(String hql, Class resultClass, int firstResult,
      int maxResults, Object... values);

  /**
   * Execute an SQL query, binding a number of values to "?" parameters in the
   * query string.
   * 
   * @param sql
   * @param firstResult
   ...
   * @return
   */
  public List<P> queryBySQL(String sql, int firstResult, int maxResults,
      Object... values);
   ...
   * @return
   */
  public List queryBySQL(String sql, Class resultClass, int firstResult,
      int maxResults, Object... values);
   ...
   */
  public List<P> queryByName(String queryName, int firstResult, int maxResults,
      Object... values);
   ...
   * @return
   */
  public List<P> queryByQBC(DetachedCriteria criteria, int firstResult,
      int maxResults);
